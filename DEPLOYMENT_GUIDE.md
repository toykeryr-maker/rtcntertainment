...
- **ตั้งค่า Build & Development Settings:**
  - **Framework Preset:** Vite
  - **Build Command:** `pnpm build` (ใช้ค่า default)
  - **Output Directory:** `dist/public`
  - **Install Command:** `pnpm install`
- **ตั้งค่า Environment Variables (ถ้าต้องการ Analytics):**
  - `VITE_ANALYTICS_ENDPOINT`: URL ของ analytics service
  - `VITE_ANALYTICS_WEBSITE_ID`: Website ID สำหรับ analytics
- คลิก "Deploy"
- รอให้ deployment เสร็จ (ประมาณ 2-5 นาที)

#### 4. **ตรวจสอบการ Deploy**
- เมื่อ deploy สำเร็จ Vercel จะให้ URL เช่น `https://your-project.vercel.app`
- ทดสอบเว็บไซต์ว่าทำงานถูกต้อง
- ตรวจสอบ routing ว่าทุกหน้าเปิดได้ปกติ
